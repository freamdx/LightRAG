...
class AnalyticDB:
    ...
    Reference:
    https://www.alibabacloud.com/help/en/analyticdb/analyticdb-for-mysql/product-overview/what-is-analyticdb-for-mysql
    """
    ...
    async def initdb(self):
        ...
        for k, v in TABLES.items():
            try:
                result = await self.query(f"SELECT 1 FROM information_schema.kepler_meta_tables "
